<template>
  <div class="h-screen flex flex-col bg-surface-50 dark:bg-surface-900">
    <!-- Header -->
    <header class="flex items-center justify-between px-4 py-3 border-b border-surface-200 dark:border-surface-700 bg-white dark:bg-surface-800">
      <div class="flex items-center gap-2">
        ...
        <h1 class="font-semibold text-surface-800 dark:text-surface-100">AI Reader</h1>
        <span
          v-if="captureCount > 0"
          class="ml-1 text-xs px-1.5 py-0.5 rounded-full bg-primary-100 text-primary-700 dark:bg-primary-900/40 dark:text-primary-300"
      ...
      <div class="flex items-center gap-1">
        <button
          ...
          :class="activeTab === tab.id ? 'bg-primary-100 text-primary-600 dark:bg-primary-900/30 dark:text-primary-400' : 'text-surface-500 hover:bg-surface-100 dark:hover:bg-surface-700'"
          :title="tab.label"
        >
